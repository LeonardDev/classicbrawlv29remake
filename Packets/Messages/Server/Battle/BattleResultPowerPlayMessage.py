...
class BattleResultPowerPlayMessage(Writer):
    ...
    def encode(self):
        ...
        self.writeVint(gainedtrophies) # Unknown (Power Play Related)
        ...
        self.writeVint(0) # Power Play Epic Points
        ...
        if self.player.tutorial <= 1:
            ...
            self.writeVint(-1) # Battle Result Type
